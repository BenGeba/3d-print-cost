      ...
      <Page size="A4" wrap style={styles.page}>
        <View style={styles.content}>
            ...
            <View wrap={false}>
                <View style={styles.qrSection}>
                    ...
                    <Text style={styles.qrDescription}>
                        Scan this QR code with your smartphone to open this calculation in the MakerCalc web app
                    </Text>
                </View>
            </View>
        </View>
          ...
          <View style={styles.header} fixed>
              <Text style={styles.title}>MakerCalc – Kalkulation</Text>
        ...
        <Text style={styles.footer} fixed={true}>
          Generated by MakerCalc • Calculation includes all applicable costs and taxes
        </Text>
      </Page>
    </Document>
  );
